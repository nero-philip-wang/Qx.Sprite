...
namespace Qx.Sprite.Core
{
    ...
    public static class StringExtensions
    {
        ...
        public static string Substring(this string source, string startString, params string[] endStrings)
        {
            ...
            if (endIndex < 0 || endIndex < startIndex)
            {
                throw new InvalidOperationException(string.Format("在源字符串中无法找到“{0}”的子串位置", endStrings.Join()));
            }
        ...
        public static string ToMd5Hash(this string value)
        {
            ...
            using (MD5 hash = MD5.Create()) // Use MD5.Create() instead of MD5CryptoServiceProvider
            {
        ...
        {
            return JsonSerializer.Deserialize(json, type, JsonUtils.JsonOptions);
        }
        ...
        {
            return collection.Join(t => t?.ToString(), separator);
        }
        ...
        {
            return string.Join(separator, collection.Select(itemFormatFunc));
        }
    }
}